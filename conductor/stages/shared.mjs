...
import {
  ...
  parseStrictJson, validateCommitMessage, verifierVerdictSkeleton, resolveGateCommands,
...
export const HARNESS_ARTIFACTS = {
  ...
  patterns: ['/.claude_review_state.json', '/.loop-conductor/', '/.agent/'],
  // ls-files 检测「是否已被目标仓库追踪」用的名字（目录名直接传）。
  tracked: ['.claude_review_state.json', '.loop-conductor', '.agent'],
};
